...
def create_viewport(
    ...
    """gui / web / cli / tui / gpio；gpio 仅 Linux，其它平台回退 cli."""
    ...
    if normalized == "web":
        # Antarmuka web SELA: server lokal + peramban/jendela native.
        # Tidak butuh PySide6, sehingga lebih tahan di Windows/Linux/macOS
        # maupun Raspberry Pi tanpa Qt.
        from src.ui.web import WebViewManager

        logger.info("create_viewport: web (antarmuka SELA)")
        return WebViewManager(event_bus=event_bus, task_manager=task_manager)
