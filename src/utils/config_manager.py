...
class ConfigManager:
    ...
    DEFAULT_CONFIG = {
        ...
        "WAKE_WORD_OPTIONS": {
            "USE_WAKE_WORD": True,
            # Model KWS bahasa Inggris (berbasis BPE) dipakai karena dapat
            # mengenali kata "SELA" - model bahasa Mandarin tidak relevan untuk
            # asisten kampus berbahasa Indonesia.
        ...
        "SHORTCUTS": {
            "ENABLED": True,
            "MANUAL_PRESS": {"modifier": "ctrl", "key": "j", "description": "Tahan untuk bicara"},
            "AUTO_TOGGLE": {"modifier": "ctrl", "key": "k", "description": "Percakapan otomatis"},
            "ABORT": {"modifier": "ctrl", "key": "q", "description": "Hentikan percakapan"},
            "MODE_TOGGLE": {"modifier": "ctrl", "key": "m", "description": "Ganti mode"},
            "WINDOW_TOGGLE": {
                "modifier": "ctrl",
                "key": "w",
                "description": "Tampilkan/sembunyikan jendela",
            },
        },
        "AEC_OPTIONS": {
            "ENABLED": False,
